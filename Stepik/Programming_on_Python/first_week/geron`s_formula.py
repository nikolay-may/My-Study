...
# В один прекрасный момент Павел решил избавить всех школьников от страданий и написать и распространить по школам программу, вычисляющую площадь треугольника 
# по трём сторонам.
...
# №2
a, b, c = int(input('Веедите число ')), int(input('Веедите число ')), int(input('Веедите число '))

def gerons_formula(a, b, c):
    P = (a + b + c) / 2
    S = (P * (P - a ) * (P - b) * (P - c)) **0.5
    return S

print(gerons_formula(a,b,c))
