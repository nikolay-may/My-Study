...
# по которой робот, когда заходит в комнату, считает количество программистов в ней и произносит его вслух: 
# "n программистов".
...
# №1
quantity_prog =int(input())
c_q1 = (quantity_prog % 100) // 10
c_q2 = quantity_prog % 10
if c_q1  == 1:
    print(str(quantity_prog) + " программистов")
elif c_q2 in (0,5,6,7,8,9):
    print(str(quantity_prog) + " программистов")
elif c_q2 == 1:
    print(str(quantity_prog) + " программист")
elif c_q2 in (2,3,4):
    print(str(quantity_prog) + " программиста")


# №2

def counting_programmers(quantity):
    count_quantity1 = (quantity % 100) // 10
    count_quantity2 = quantity % 10
    if count_quantity1 == 1 and count_quantity2 in (0, 5, 6, 7, 8, 9):
        return str(quantity) + " прогрaммистов"
    elif count_quantity2 == 1:
        return str(quantity) + " программист"
    elif count_quantity2 in (2, 3, 4):
        return str(quantity) + " программиста"

quantity = int(input("Сколько программистов в комнате  увидел робот ? \n "))

print(counting_programmers(quantity))